...
# without biology
ax_p.step(IC_prev_avg_max,p,lw=2,color='tab:blue', label='without biology')
ax_p.step(IC_prev_avg_max,p+eps_DKW,linestyle='--',lw=2,color='tab:cyan')
ax_p.step(IC_prev_avg_max,p-eps_DKW,linestyle='--',lw=2,color='tab:cyan')
# with biology
ax_p.step(IC_prev_avg_max_bio,p,lw=2,color='tab:green',label='with biology')
ax_p.step(IC_prev_avg_max_bio,p+eps_DKW,linestyle=':',lw=2,color='tab:olive')
ax_p.step(IC_prev_avg_max_bio,p-eps_DKW,linestyle=':',lw=2,color='tab:olive')
# general settings
ax_p.set_xscale('log')
...
# without biology
ax_e.step(IC_ex_max,p,lw=2,color='tab:blue')
ax_e.step(IC_ex_max,p+eps_DKW,linestyle='--',lw=2,color='tab:cyan')
ax_e.step(IC_ex_max,p-eps_DKW,linestyle='--',lw=2,color='tab:cyan')
# with biology
ax_e.step(IC_ex_max_bio,p,lw=2,color='tab:green')
ax_e.step(IC_ex_max_bio,p+eps_DKW,linestyle=':',lw=2,color='tab:olive')
ax_e.step(IC_ex_max_bio,p-eps_DKW,linestyle=':',lw=2,color='tab:olive')
# general settings
ax_e.set_xscale('log')
