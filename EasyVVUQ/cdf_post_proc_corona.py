...
# without biology
ax_p.step(IC_prev_avg_max,p,lw=2,label='without biology')
ax_p.step(IC_prev_avg_max,p+eps_DKW,linestyle='--',lw=2,color='tab:orange')
ax_p.step(IC_prev_avg_max,p-eps_DKW,linestyle='--',lw=2,color='tab:orange')
# with biology
ax_p.step(IC_prev_avg_max_bio,p,lw=2,label='with biology')
ax_p.step(IC_prev_avg_max_bio,p+eps_DKW,linestyle='--',lw=2,color='tab:orange')
ax_p.step(IC_prev_avg_max_bio,p-eps_DKW,linestyle='--',lw=2,color='tab:orange')
# general settings
ax_p.set_xscale('log')
...
ax_e.step(IC_ex_max,p-eps_DKW,linestyle='--',lw=2,color='tab:orange')
# with biology
ax_e.step(IC_ex_max_bio,p,lw=2)
ax_e.step(IC_ex_max_bio,p+eps_DKW,linestyle='--',lw=2,color='tab:orange')
ax_e.step(IC_ex_max_bio,p-eps_DKW,linestyle='--',lw=2,color='tab:orange')
# general settings
ax_e.set_xscale('log')
