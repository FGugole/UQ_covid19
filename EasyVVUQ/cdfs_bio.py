...
CT_campaign = uq.Campaign(state_file = "campaign_state_CT_bio_MC1000.json", work_dir = "/tmp")
print('========================================================')
...
FC_campaign = uq.Campaign(state_file = "campaign_state_FC_bio_MC1000.json", work_dir = "/tmp")
print('========================================================')
...
IL_campaign = uq.Campaign(state_file = "campaign_state_IL_bio_MC1000.json", work_dir = "/tmp")
print('========================================================')
...
PO_campaign = uq.Campaign(state_file = "campaign_state_PO_bio_MC1000.json", work_dir = "/tmp")
print('========================================================')
...
ax_e.step(IL_IC_ex_max,p,lw=2,color='hotpink')
