...
plt.tight_layout()
f.savefig('figures/cdf_CT_MC100_comparison.png')
...
########################
# Reload the campaign
campaign = uq.Campaign(state_file = "campaign_state_FC_MC100.json", work_dir = "/tmp")
print('========================================================')
print('Reloaded campaign', campaign.campaign_dir.split('/')[-1])
print('========================================================')
...
campaign.collate()
# get full dataset of data
data_FC = campaign.get_collation_result()
