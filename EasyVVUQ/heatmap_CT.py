...
ax_p = f.add_subplot(121, xlabel='trace_prob_E', ylabel='trace_contact_reduction', zlabel='trace_rate_I', projection='3d')
...
ax_e = f.add_subplot(122, xlabel='trace_prob_E', ylabel='trace_contact_reduction', zlabel='trace_rate_I', projection='3d')
