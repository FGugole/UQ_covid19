...
campaign = uq.Campaign(name='virsim_CT_bio_', work_dir=workdir)
...
cwd = os.getcwd()
pcmd = f"ls -d {campaign.campaign_dir}/runs/Run_* | parallel -j 4 'cd {{}} ; Rscript {cwd}/contact_tracing_UQ_bio.r corona_in.json > output.txt ; cd .. '"
