...
my_campaign = uq.Campaign(name='virsim_IL_nobio_', work_dir=workdir)
...
cwd = os.getcwd()
pcmd = f"ls -d {my_campaign.campaign_dir}/runs/Run_* | parallel -j 4 'cd {{}} ; Rscript {cwd}/intermittent_lockdown_UQ.r corona_in.json > output.txt ; cd .. '"
