...
ax.plot(x_IL,beta_lockeffect.pdf(x_IL),ls='-.',lw=2,label='pl_intervention_effect_hi')
ax.set_xticks([0.0, .5, 1.0])
...
ax.plot(x_IL_length,gamma_phase_interval.pdf(x_IL_length),lw=2,label='intervention_lift_interval')
