...
\centering
	\begin{subfigure}[b]{.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{figures/total_type3.pdf}
	\caption{Total index.\label{fig:total_type3}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{figures/first_type3.pdf}
	\caption{First order.\label{fig:first_type3}}
	\end{subfigure}\\
	\begin{subfigure}[b]{.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{figures/second_type3.pdf}
...
\centering
	\begin{subfigure}[b]{.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{figures/total_QoI.pdf}
	\caption{Total index.\label{fig:total_QoI}}
	\end{subfigure}
	\hfill
	\begin{subfigure}[b]{.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{figures/first_QoI.pdf}
	\caption{First order.\label{fig:first_QoI}}
	\end{subfigure}\\
	\begin{subfigure}[b]{.49\textwidth}
	\centering
	\includegraphics[width=\textwidth]{figures/second_QoI.pdf}
