...
intervention_effect = c(1, .3, .15, .25, <X0001>)
intervention_uptake = rep(<X0002>, length(intervention_t))
...
#############################
write.csv(x=flat_curve_data, file='output_flattening_the_curve.csv', row.names=FALSE)
