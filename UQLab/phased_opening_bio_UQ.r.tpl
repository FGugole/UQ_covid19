...
avg_duration_infectiousness <- <X0006>  

avg_contact_rate <- Rzero / avg_duration_infectiousness

shape_exposed_time <- <X0007>

intervention_effect_var_inv <- <X0008>
...
#############################
write.csv(x=phased_opening_data, file='output_phased_opening_bio.csv', row.names=FALSE)
