...
trace_prob_E = c(rep(0, 4), 0.38167600)
trace_rate_I = c(rep(0, 4), 0.88424421)
trace_contact_reduction = c(rep(0, 4), 0.91816140)
...
#############################
write.csv(x=contact_tracing_data, file='output_contact_tracing000001.csv', row.names=FALSE)
